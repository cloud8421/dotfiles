...
# RPROMPT='%{$fg[yellow]%}$(~/.rvm/bin/rvm-prompt v g)%{$reset_color%} $(git_prompt_info)%{$reset_color%}$(git_prompt_status)%{$reset_color%}'
RPROMPT='%{$fg[yellow]%}$(~/.rvm/bin/rvm-prompt v g)%{$reset_color%}'
